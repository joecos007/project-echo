...
function TeamCard({ member, index }: { member: TeamMember; index: number }) {
    const parallaxRef = useParallax(0.5 + (index % 3) * 0.1); // Varying speeds

    return (
        <div ref={parallaxRef}>
            <FadeInView direction="up" delay={index * 0.05}>
                <div className="glass-panel p-6 group hover:border-neon-quill/30 transition-all text-center">
                    {/* Image */}
    ...
    return (
        <div className="pt-24 min-h-screen bg-background text-foreground">
            ...
            <section className="text-center py-20 px-4">
                <TextReveal type="word" className="font-display text-6xl md:text-8xl text-gilt-gold mb-6">
                    Meet Our Team
                </TextReveal>
